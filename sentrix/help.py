...
CATEGORIES = (
    HelpCategory("admin", "👮 Admin", "Moderate members and manage administrators.", ("promote", "demote", "ban", "unban", "kick", "mute", "unmute", "warn", "unwarn", "warnings", "purge")),
    HelpCategory("protection", "🛡️ Protection", "Protect your group from spam, raids, and unwanted content.", ("antispam", "antiraid", "captcha", "lock", "unlock", "setflood")),
    ...
    HelpCategory("logging", "📢 Logging", "Configure the dedicated admin log channel.", ("setlog", "unsetlog", "logchannel", "logsettings")),
    HelpCategory("setup", "⚙️ Setup", "Configure the current group interactively.", ("setup", "settings", "rules", "setrules", "reset", "language")),
    HelpCategory("connections", "🔗 Connections", "Manage groups from the bot private chat.", ("connect", "disconnect", "connection")),
    HelpCategory("info", "📊 Information", "Inspect IDs, admins, reports, and statistics.", ("id", "info", "admins", "stats", "report")),
    HelpCategory("bot", "🤖 Bot", "SentriX status and discovery commands.", ("start", "help", "about", "ping")),
)
